...
export default [
  ...
  {
    path: '/docs/0.15.17/tags',
    component: ComponentCreator('/docs/0.15.17/tags','5dc'),
    exact: true
  },
  {
    path: '/docs/1.0.5/tags',
    component: ComponentCreator('/docs/1.0.5/tags','e21'),
    exact: true
  },
  {
    path: '/docs/1.1.0/tags',
    component: ComponentCreator('/docs/1.1.0/tags','403'),
    exact: true
  },
  {
    path: '/docs/1.2.0/tags',
    component: ComponentCreator('/docs/1.2.0/tags','21a'),
    exact: true
  },
  {
    path: '/docs/1.3.0/tags',
    component: ComponentCreator('/docs/1.3.0/tags','ccd'),
    exact: true
  },
  {
    path: '/docs/1.3.1/tags',
    component: ComponentCreator('/docs/1.3.1/tags','ca7'),
    exact: true
  },
  {
    path: '/docs/1.4/tags',
    component: ComponentCreator('/docs/1.4/tags','00f'),
    exact: true
  },
  {
    path: '/docs/next/tags',
  ...
  {
    path: '/docs/tags',
    component: ComponentCreator('/docs/tags','8dd'),
    exact: true
  },
  {
    path: '/search',
    component: ComponentCreator('/search','c6a'),
    exact: true
  },
  {
    path: '/users',
  ...
  {
    path: '/docs/0.15.17',
    component: ComponentCreator('/docs/0.15.17','441'),
    routes: [
      {
  ...
  {
    path: '/docs/1.0.5',
    component: ComponentCreator('/docs/1.0.5','cad'),
    routes: [
      {
  ...
  {
    path: '/docs/1.1.0',
    component: ComponentCreator('/docs/1.1.0','dd6'),
    routes: [
      {
  ...
  {
    path: '/docs/1.2.0',
    component: ComponentCreator('/docs/1.2.0','4e4'),
    routes: [
      {
  ...
  {
    path: '/docs/1.3.0',
    component: ComponentCreator('/docs/1.3.0','c64'),
    routes: [
      {
  ...
  {
    path: '/docs/1.3.1',
    component: ComponentCreator('/docs/1.3.1','92d'),
    routes: [
      {
  ...
  {
    path: '/docs/1.4',
    component: ComponentCreator('/docs/1.4','adf'),
    routes: [
      {
